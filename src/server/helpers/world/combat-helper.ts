...
export const BaseItemStatsPerTier = {
  ...
  Dagger:               { base: 2, min: 0, max: 1, weakChance: 1,  damageBonus: 20 },
  ...
  Greataxe:             { base: 5, min: 1, max: 2, weakChance: 10, damageBonus: 0 },
  Greatmace:            { base: 5, min: 1, max: 2, weakChance: 10, damageBonus: 0 },
  Greatsword:           { base: 3, min: 1, max: 4, weakChance: 10, damageBonus: 0 },
  ...
  Shortsword:           { base: 1, min: 1, max: 3, weakChance: 15, damageBonus: 10 },
