...
export const responses = (npc: NPC) => {
  ...
  npc.parser.addCommand('hello')
    ...
    .set('logic', (args, { player }) => {
      player.$$room.analyticsHelper.trackTutorial(player, 'Billy:Hello');
  ...
  npc.parser.addCommand('merchants')
    ...
    .set('logic', (args, { player }) => {
      player.$$room.analyticsHelper.trackTutorial(player, 'Billy:Merchants');
  ...
  npc.parser.addCommand('hermit')
    .set('syntax', ['hermit'])
    .set('logic', (args, { player }) => {
      player.$$room.analyticsHelper.trackTutorial(player, 'Billy:Hermit');
