...
export class KillApprentices extends Quest {
  ...
  public static updateProgress(player: Player, questOpts: any = {}): void {
    ...
    if(structure.kills <= this.killsRequired) {
      player.sendQuestMessage(this, `You have killed ${structure.kills}/${this.killsRequired} apprentices and golems.`);
    }
  ...
  public static incompleteText(player: Player): string {
    ...
    return `By my records, you have to kill ${this.killsRequired - kills} apprentices and golems yet!`;
  }
