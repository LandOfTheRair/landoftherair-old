...
export class DailyKillThermidors extends Quest {
  ...
  public static updateProgress(player: Player, questOpts: any = {}): void {
    ...
    if(structure.kills <= this.killsRequired) {
      player.sendQuestMessage(this, `You have killed ${structure.kills}/${this.killsRequired} lake people.`);
    }
  ...
  public static incompleteText(player: Player): string {
    ...
    return `Thanks for offering your help. You have to kill ${this.killsRequired - kills} more lake people.`;
  }
