...
export class KillDistractions extends Quest {
  ...
  public static updateProgress(player: Player, questOpts: any = {}): void {
    ...
    if(structure.kills <= this.killsRequired) {
      player.sendQuestMessage(this, `You have killed ${structure.kills}/${this.killsRequired} distractions.`);
    }
  ...
  public static incompleteText(player: Player): string {
    ...
    return `Short ${this.killsRequired - kills} distractions.`;
  }
