...
const BATTLEMAGE_TREE = {
  Battlemage: {
    ...
    unlocks: ['LightenArmor0', 'BladedWands0', 'StrongMind0', 'FindFamiliar', 'RiftSlash', 'MagicalReinforcement0']
  },

  // TRAITS
  MagicalReinforcement0: {
    unlocks: ['MagicalReinforcement1']
  },
  MagicalReinforcement1: {
