...
const FLOWER_LAYOUT = [
  ...
  MaterialSlot.MinesFlower, MaterialSlot.FrostlandsGourd, MaterialSlot.CatacombsFrostflower, null, null
];

const SCALE_LAYOUT = [
  MaterialSlot.RedEtherScale, MaterialSlot.SilverScale, null, null, null,
