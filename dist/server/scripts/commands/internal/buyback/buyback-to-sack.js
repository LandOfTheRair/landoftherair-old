...
class BuybackToSack extends Command_1.Command {
    constructor() {
        super(...arguments);
        this.name = '~OtS';
    ...
    execute(player, { room, gameState, args }) {
        ...
        if (!player.addItemToSack(newItem))
            return;
        player.buyItemBack(slot);
        player.loseGold(item._buybackValue);
    }
}
exports.BuybackToSack = BuybackToSack;
//# sourceMappingURL=buyback-to-sack.js.map