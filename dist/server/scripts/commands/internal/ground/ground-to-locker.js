...
class GroundToLocker extends Command_1.Command {
    constructor() {
        super(...arguments);
        this.name = '~GtW';
        this.format = 'ItemType ItemId LockerID';
    }
...
exports.GroundToLocker = GroundToLocker;
//# sourceMappingURL=ground-to-locker.js.map